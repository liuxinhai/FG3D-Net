...
from roi_data_layer.layer_airplanev1_v20 import RoIDataLayer
...
class SolverWrapper(object):
    ...
    def __init__(self, sess, saver, network, network1, network2, network3, network4, network5, network6, network7,
                 network8, network9, network10, network11, network12, network13, network14, network15, network16, network17, network18, network19, imdb, roidb, output_dir, pretrained_model=None):
	...
	'''
        ...
        # fc2_w = tf.get_variable('fc2_w', [self.feature_size, self.classes], dtype=tf.float32,
        #                         initializer=w_init)
...
def train_net(sess1, network, network1, network2, network3, network4, network5, network6, network7, network8, network9,
              network10, network11, network12, network13, network14, network15, network16, network17, network18, network19, imdb, roidb, output_dir, pretrained_model=None, max_iters=40000):
    """Train a Fast R-CNN network."""
    ...
    with tf.Session(config=config) as sess:
        sw = SolverWrapper(sess, saver, network, network1, network2, network3, network4, network5, network6, network7,
                           network8, network9, network10, network11, network12, network13, network14, network15, network16, network17, network18, network19, imdb, roidb, output_dir,
