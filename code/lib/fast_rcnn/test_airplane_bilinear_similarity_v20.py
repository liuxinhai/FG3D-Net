...
import gt_data_layer.roidb_airplane_v20 as gdl_roidb
import roi_data_layer.roidb_airplane_v20 as rdl_roidb
from roi_data_layer.layer_airplanev1_test_v20 import RoIDataLayer
...
class SolverWrapper(object):
    ...
    def __init__(self, sess, saver, network,network1,network2,network3,network4,network5,network6,network7,network8,network9,network10,network11,network12, network13, network14, network15, network16, network17, network18, network19, imdb, roidb, output_dir, pretrained_model=None):
        ...
        self.net12 = network12
        self.net13 = network13
        self.net14 = network14
        self.net15 = network15
        self.net16 = network16
        self.net17 = network17
        self.net18 = network18
        self.net19 = network19
...
def train_net(sess1, network,network1,network2,network3,network4,network5,network6,network7,network8,network9,network10,network11, network12, network13, network14, network15, network16, network17, network18, network19, imdb, roidb, output_dir, pretrained_model=None, max_iters=40000):
    """Train a Fast R-CNN network."""
    ...
    with tf.Session(config=config) as sess:
        sw = SolverWrapper(sess, saver, network,network1,network2,network3,network4,network5,network6,network7,network8,network9,network10,network11,network12, network13, network14, network15, network16, network17, network18, network19, imdb, roidb, output_dir, pretrained_model=pretrained_model)
