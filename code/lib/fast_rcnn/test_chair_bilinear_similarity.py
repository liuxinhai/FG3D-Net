...
class SolverWrapper(object):
    ...
    def train_model(self, sess, max_iters):
        ...
        class_ac_test = True
        # class_ac_test = False
        class_acc = np.zeros(33, np.float32)
        cmatrix = np.zeros([33,33], np.float32)

        model_num = 1930
        classes_num = [20,100,100,100,5,10,50,20,5,100,50,100,100,100, 40,50,100,50,30,50,100,100,50,100,100,100,20,100,5,5,20,20,30]
        cnum = [[20],[100],[100],[100],[5],[10],[50],[20],[5],[100],[50],[100],[100],[100], [40],[50],[100],[50],[30],[50],[100],[100],[50],[100],[100],[100],[20],[100],[5],[5],[20],[20],[30]]
        part_attention = np.zeros([1930, 12, 20, 20], np.float32)
        view_attention = np.zeros([1930, 12, 12], np.float32)
        ...
        '''
            ...
            timer.toc()
            print(iter)
        sio.savemat('/data/lxh/Models/fine-grained/attention/part_att_chair3.mat', {'pt': part_attention})
        sio.savemat('/data/lxh/Models/fine-grained/attention/view_att_chair3.mat', {'vt': view_attention})
       '''
