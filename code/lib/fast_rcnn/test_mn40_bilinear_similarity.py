...
from fast_rcnn.config_mn40 import cfg
import gt_data_layer.roidb_mn40 as gdl_roidb
import roi_data_layer.roidb_airplane as rdl_roidb
from roi_data_layer.layer_mn40_test import RoIDataLayer
...
class SolverWrapper(object):
    ...
    def train_model(self, sess, max_iters):
        ...
        class_ac_test = True
        class_acc = np.zeros(40, np.float32)
        if class_ac_test == True:
            model_num = 2468
            classes_num = [100,50,100,20,100,100,20,100,100,20,20,20,86,20,86,20,100,100,20,20,20,100,100,86,20,100,100,20,100,20,100,20,20,100,20,100,100,100,20,20]
        else:
            model_num = 9843
            classes_num = [626,106,515,173,572,335,64,197,889,167,79,138,200,109,200,149,171,155,145,124,149,284,465,200,88,231,240,104,115,128,680,124,90,392,163,344,267,475,87,103]
        ...
        fid = open('/home/liuxinhai/fine-grained/results/mn40_results_0.txt', 'a+')
        ...
        fid = open('/home/liuxinhai/fine-grained/results/mn40_results_0_class.txt', 'a+')
