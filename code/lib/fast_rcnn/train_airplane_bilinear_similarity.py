...
class SolverWrapper(object):
    ...
    def train_model(self, sess, max_iters):
        ...
        similarity = tf.reduce_sum(L1_S1_Similarity, axis=0, keep_dims=True)
        ...
        similarity1 = tf.reduce_sum(L1_S1_Similarity1, axis=0, keep_dims=True)
        ...
        similarity2 = tf.reduce_sum(L1_S1_Similarity2, axis=0, keep_dims=True)
        ...
        similarity3 = tf.reduce_sum(L1_S1_Similarity3, axis=0, keep_dims=True)
        ...
        similarity4 = tf.reduce_sum(L1_S1_Similarity4, axis=0, keep_dims=True)
        ...
        similarity5 = tf.reduce_sum(L1_S1_Similarity5, axis=0, keep_dims=True)
        ...
        similarity6 = tf.reduce_sum(L1_S1_Similarity6, axis=0, keep_dims=True)
        ...
        similarity7 = tf.reduce_sum(L1_S1_Similarity7, axis=0, keep_dims=True)
        ...
        similarity8 = tf.reduce_sum(L1_S1_Similarity8, axis=0, keep_dims=True)
        ...
        similarity9 = tf.reduce_sum(L1_S1_Similarity9, axis=0, keep_dims=True)
        ...
        similarity10 = tf.reduce_sum(L1_S1_Similarity10, axis=0, keep_dims=True)
        ...
        similarity11 = tf.reduce_sum(L1_S1_Similarity11, axis=0, keep_dims=True)
        ...
        view_similarity = tf.reduce_sum(L1_S2_Similarity, axis=0, keep_dims=True)
        ...
        global_similarity = tf.reduce_sum(L2_S1_Similarity, axis=0, keep_dims=True)
        ...
        model_feature = tf.concat([global_sums, view_sums], axis=1)
        print(model_feature)
        ...
        fc2_w = tf.get_variable('fc2_w', [2*self.feature_size, self.classes], dtype=tf.float32,
                                initializer=w_init)
        ...
        for iter in range(max_iters):
            ...
            if (iter + 1) % (cfg.TRAIN.DISPLAY) == 0:
                print('iter: %d / %d, loss: %.4f, lr: %f' % (iter + 1, max_iters, loss_value, cfg.TRAIN.LEARNING_RATE))
