...
from roi_data_layer.layer_modelnet10 import RoIDataLayer
...
class SolverWrapper(object):
    ...
    def __init__(self, sess, saver, network, network1, network2, network3, network4, network5, network6, network7,
                 network8, network9, network10, network11, imdb, roidb, output_dir, pretrained_model=None, learning_rate=0.00001, current_epoch=0):
    ...
    def snapshot(self, sess, iter):
        ...
        filename = (cfg.TRAIN.SNAPSHOT_PREFIX + infix +
                        '_iter_{:d}'.format(self.current_epoch + iter+1) + '.ckpt')
...
def train_net(sess1,network, network1, network2, network3, network4, network5, network6, network7, network8, network9,
              network10, network11, imdb, roidb, output_dir, pretrained_model=None, max_iters=40000, learning_rate=0.00001, current_epoch=0):
    """Train a Fast R-CNN network."""
