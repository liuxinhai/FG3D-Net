...
class SolverWrapper(object):
    ...
    def __init__(self, sess, saver, network, network4,
                 network8, imdb, roidb, output_dir, pretrained_model=None):
    ...
    def train_model(self, sess, max_iters):
        ...
        # concat views
        view_parts = tf.concat([part_sum, part_sum4], axis=0)
        ...
        for iter in range(max_iters):
            ...
            # training
            loss_value, _ = sess.run([loss, train_op], feed_dict=feed_dict, options=run_options,
...
def train_net(sess1, network, network4, network8,
               imdb, roidb, output_dir, pretrained_model=None, max_iters=40000):
    """Train a Fast R-CNN network."""
    ...
    with tf.Session(config=config) as sess:
        sw = SolverWrapper(sess, saver, network, network4,
                           network8, imdb, roidb, output_dir,
