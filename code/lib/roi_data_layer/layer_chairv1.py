...
from roi_data_layer.minibatch_chair import get_minibatch
import numpy as np
import random
...
class RoIDataLayer(object):
    ...
    def __init__(self, roidb, num_classes):
        ...
        self._classnum = [48, 1578, 226, 606, 20, 35, 114, 41, 10, 310, 217, 665, 458, 990, 73, 186, 256, 241, 84, 154, 614, 407, 121, 307, 1553, 777, 51, 748, 18, 7, 65, 55, 89]
        ...
        for i in range(len(self._classnum)):
            temp = [1.0 if k == i else 0.0 for k in range(33)]
