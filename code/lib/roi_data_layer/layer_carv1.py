...
from roi_data_layer.minibatch_car import get_minibatch
import numpy as np
import random
...
class RoIDataLayer(object):
    ...
    def __init__(self, roidb, num_classes):
        ...
        self._classnum = [16,936,528,62,276,109,115,25,468,77,102,477,201,383,2027,209,427,427,14,131]
        ...
        for i in range(len(self._classnum)):
            temp = [1.0 if k == i else 0.0 for k in range(20)]
