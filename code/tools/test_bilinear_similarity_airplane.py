...
import _init_paths
from fast_rcnn.test_airplane_bilinear_similarity import get_training_roidb, train_net
...
if __name__ == '__main__':
    ...
    # train_net(sess1, network, network2, network4, network6,  network8,network10,
    #           imdb, roidb, output_dir, \
    #           pretrained_model=args.pretrained_model, \
    #           max_iters=args.max_iters)
