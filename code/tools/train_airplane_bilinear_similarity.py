...
import _init_paths
from fast_rcnn.train_airplane_bilinear_similarity_softmax import get_training_roidb, train_net
from fast_rcnn.config_airplane import cfg,cfg_from_file, cfg_from_list, get_output_dir
from datasets.factory_airplane import get_imdb
...
if __name__ == '__main__':
    ...
    train_net(network,network1,network2,network3,network4,network5,network6,network7,network8,network9,network10,network11, imdb, roidb, output_dir,\
              pretrained_model=args.pretrained_model,\
             max_iters=args.max_iters)
