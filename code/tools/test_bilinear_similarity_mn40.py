...
import _init_paths
from fast_rcnn.test_mn40_bilinear_similarity import get_training_roidb, train_net
from fast_rcnn.config_mn40 import cfg,cfg_from_file, cfg_from_list, get_output_dir
from datasets.factory_mn40 import get_imdb
